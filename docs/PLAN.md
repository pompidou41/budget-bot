...
**Лист "Сводка"** — сводная таблица по неделям/категориям (категории по строкам, недели по столбцам). Бот читает категории из этого листа при регистрации. Пользователь ведёт "Сводку" вручную.
