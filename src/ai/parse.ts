...
- account / toAccount: ID из списка счетов, только если счёт назван явно — по ID, названию, банку или алиасу. Не назван — NONE. НИКОГДА не угадывай счёт.
- amount: число > 0 в валюте счёта. "1.5к", "полторы тысячи" = 1500. Не названа — 0.
- currency: валюта, в которой пользователь назвал сумму ("$", "долларов", "usdt", "руб"), иначе пустая строка. Сумму в другую валюту не пересчитывай.
